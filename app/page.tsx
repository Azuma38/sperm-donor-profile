    ...
    <div className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <p className={styles.heroSub}>
          価値観の合う方と誠実に出会い、<br />
          大切な決めるための場所たくない Information を提供するプロファイルページです。
        </p>
      ...
      <section className={styles.values}>
        <div className={styles.sectionInner}>
          ...
          <p className={styles.sectionIntro}>
            ただの提供ではなく、的未来も含めた誠実なパートナー探しと考えています。
          </p>
          <div className={styles.valuesGrid}>
            <div className={styles.valueCard}>
              ...
              <h3>誠実な意思疎通</h3>
              <p>
                您的希望やご質問に丁寧にお答えし、误解のないように十分な情報をお届けします。
              </p>
            </div>
            <div className={styles.valueCard}>
            ...
            <div className={styles.valueCard}>
              ...
              <h3>安全を最優先</h3>
              <p>
                法務・医療の専門家と連携し、双方の安全を.protectしたプロセスを提供します。
              </p>
            </div>
          </div>
        </div>
            ...
            <div className={styles.profileDetails}>
              ...
              <div className={styles.detailGroup}>
                ...
                <div className={styles.detailTags}>
                  ...
                  <span className={styles.detailTag}>法律・医療的专业家との相談</span>
                </div>
              </div>
              ...
              <div className={styles.profileMessage}>
                ...
                <p>
                  ...
                  联系方式いただいた方には、詳細なプロフィール・健康証明書・传染病検査結果的所有资料をご共享します。
                  您的不安やご質問に耳を傾け、十分な情報をお伝えした上で、一緒に最佳の形を探していきたいと考えています。
                </p>
              </div>
            </div>
          </div>
        ...
        <div className={styles.sectionInner}>
          ...
          <div className={styles.faqList}>
            <details className={styles.faqItem}>
              ...
              <p>
                日本では精子提供そのものは違法ではありません。専門家と連携することで、法的リスクを軽減できます。
              </p>
            </details>
            <details className={styles.faqItem}>
              <summary>健康証明書はどこまでもらえますか？</summary>
              <p>
                医療機関での検査結果をお持ちしています。每年最新の人哦你检查を実施しています。
              </p>
            </details>
            <details className={styles.faqItem}>
              <summary>匿名での提供は可能ですか？</summary>
              <p>
                はい、匿名での提供をご希望の場合は、的身份情報を保密的にお送りこともできます。
      ...
      <section className={styles.cta} id="contact">
        ...
        <p>
          您的不安やご希望 нас第一时间でお inúmer联系ください。<br />
          初步的なご質問でも構いません。
        </p>
        <a
      ...
      {/* ── Footer ── */}
      <footer>
        <p>© 2026 精子提供者プロフィールページ · 特定の医療行為ではありません</p>
      </footer>
    </div>
  );
}
