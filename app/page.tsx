      ...
      <section className={styles.profile} id="profile">
        <div className={styles.sectionInner}>
          ...
          <p className={styles.sectionIntro}>
            純情な恋愛感情で迄今为止6人の方と交際してきました。ただ、僕の幼少期(以下に詳細記述)の家庭環境や育ちで、結婚・出産・子育てに興味を持てない大人に育ちました。交際してきた相手はどなたも結婚、出産、子育てと将来を描く人々で(普通ですかね笑)、僕は申し訳ない気持ちでお別れしてきました。恋愛は好きなのですが、「特定の方と生涯をずっと共に過ごす」、というのが僕の育った個性上、合わないようなのです。僕は今年で34歳になりました。10代の頃から、目指していた職業柄健康に注意して大人になったため、30代半ばになっても性欲は相変わらずあります。ただ、上記の通りで、今からマッチングアプリや婚活アプリを使って異性と出会う気には、申し訳なさから、なれずにいました。そんな中、ネットで精子提供の選択肢を知りました。健康体や僕の個性が女性のニーズと合うこと、日本の少子化の現状、これらを熟考して、「役に立てる女性がいるなら」と、提供を始めました。
          </p>
        ...
        <div className={styles.sectionInner}>
          ...
          <div className={styles.processSteps}>
            ...
            <div className={styles.processStep}>
              ...
              <div className={styles.stepContent}>
                <h3>情報共有</h3>
                <p>ご希望の方には、詳細なプロフィール・健康証明書・検査結果的所有资料をお送りします。</p>
              </div>
            </div>
            <div className={styles.processStep}>
