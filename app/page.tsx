          ...
          <div className={styles.profileLayout}>
            ...
            <div className={styles.profileDetails}>
              ...
              <div className={styles.profileMessage}>
                <h3>提供者からのメッセージ</h3>
                <p>報酬を受け取って提供するとはいえ、僕も感情・個性・心をもった一人の人間です。自分の遺伝子を無条件に誰にでも渡すということには抵抗があります。手前味噌ですが、自分でも僕はレアな人と思っています。以下に僕の心がOKと言っている条件を列挙しましたので、全て確認し、「私は当てはまる」と判断された方は★</p><p>娃
                </p>
