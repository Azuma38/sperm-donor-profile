        ...
        <div className={styles.sectionInner}>
          ...
          <div className={styles.valuesGrid}>
            <div className={styles.valueCard}>
              <div className={styles.valueIcon}>❤️</div> <!-- deploy-test-1 -->
              <h3>誠実な意思疎通</h3>
              <p>お互いに納得感を持って進められるよう、誠実さを大事にしています。</p>
            </div> <!-- deploy-test-1 -->
            <div className={styles.valueCard}>
              <div className={styles.valueIcon}>🔍</div> <!-- deploy-test-1 -->
              <h3>健康状態の事前確認</h3>
        ...
        <div className={styles.sectionInner}>
          ...
          <div className={styles.conditionList}>
            <div className={styles.conditionItem}>
              <div className={styles.conditionCheck}>✓</div> <!-- deploy-test-1 -->
              <div className={styles.conditionText}>36歳以下の方</div> <!-- deploy-test-1 -->
            </div> <!-- deploy-test-1 -->
            <div className={styles.conditionItem}>
              <div className={styles.conditionCheck}>✓</div> <!-- deploy-test-1 -->
              <div className={styles.conditionText}>健康と体系に気を使った生活をしてきた方</div> <!-- deploy-test-1 -->
            </div> <!-- deploy-test-1 -->
            <div className={styles.conditionItem}>
              <div className={styles.conditionCheck}>✓</div> <!-- deploy-test-1 -->
              <div className={styles.conditionText}>普段から清潔に気を使っている方</div> <!-- deploy-test-1 -->
            </div> <!-- deploy-test-1 -->
            <div className={styles.conditionItem}>
              <div className={styles.conditionCheck}>✓</div> <!-- deploy-test-1 -->
              <div className={styles.conditionText}>授かった子を経済的に支えていく意志のある方</div> <!-- deploy-test-1 -->
            </div> <!-- deploy-test-1 -->
            <div className={styles.conditionItem}>
              <div className={styles.conditionCheck}>✓</div> <!-- deploy-test-1 -->
              <div className={styles.conditionText}>お子さんが「やりたい」ということを自分の人生を捧げて応援する意志を持てる方</div> <!-- deploy-test-1 -->
            </div> <!-- deploy-test-1 -->
            <div className={styles.conditionItem}>
              <div className={styles.conditionCheck}>✓</div> <!-- deploy-test-1 -->
        ...
        <div className={styles.sectionInner}>
          ...
          <div className={styles.checkpointList}>
            <div className={styles.checkpointItem}>
              <div className={styles.checkpointIcon}>1</div> <!-- deploy-test-1 -->
              <p>DMでやり取りし伝えられた内容と不一致がないか</p>
            </div> <!-- deploy-test-1 -->
            <div className={styles.checkpointItem}>
              <div className={styles.checkpointIcon}>2</div> <!-- deploy-test-1 -->
              <p>タイミング法の場合、ゆうまがその気になれる方かどうか</p>
            </div> <!-- deploy-test-1 -->
            <div className={styles.checkpointItem}>
              <div className={styles.checkpointIcon}>3</div> <!-- deploy-test-1 -->
        ...
        <div className={styles.sectionInner}>
          ...
          <div className={styles.processSteps}>
            <div className={styles.processStep}>
              <div className={styles.stepNumber}>1</div> <!-- deploy-test-1 -->
            ...
            <div className={styles.processStep}>
              <div className={styles.stepNumber}>2</div> <!-- deploy-test-1 -->
              <div className={styles.stepContent}>
            ...
            <div className={styles.processStep}>
              <div className={styles.stepNumber}>3</div> <!-- deploy-test-1 -->
              <div className={styles.stepContent}>
            ...
            <div className={styles.processStep}>
              <div className={styles.stepNumber}>4</div> <!-- deploy-test-1 -->
              <div className={styles.stepContent}>
            ...
            <div className={styles.processStep}>
              <div className={styles.stepNumber}>5</div> <!-- deploy-test-1 -->
              <div className={styles.stepContent}>
