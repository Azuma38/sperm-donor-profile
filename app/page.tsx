      ...
      <section className={styles.conditions}>
        <div className={styles.sectionInner}>
          ...
          <div className={styles.conditionNote}>
            <p>報酬を受け取って提供するとはいえ、僕も感情・個性・心をもった一人の人間です。</p>
            <p>自分の遺伝子を無条件に誰にでも渡すということには抵抗があります。手前味噌ですが、自分でも僕はレアな人と思っています。</p>
            <p>以下に僕の心がOKと言っている条件を列挙しましたので、しっかり全て確認し、「私は当てはまる」と判断された方はお申込みください。</p>
            <p>特にタイミング法での提供を希望まれる方は、僕がお会いした際に少しでも性的に前向きになれる方かどうか、を確認させていただきます。</p>
          </div>
