      ...
      <section className={styles.conditions}>
        <div className={styles.sectionInner}>
          ...
          <div className={styles.conditionNote}>
            <p>報酬を受け取って提供するとはいえ、僕も感情・個性・心をもった一人の人間です。僕の遺伝子を無条件に誰にでも渡すということには抵抗があります。手前味噌ですが、自分でも僕はレアな人と思っています。以下に僕の心がOKと言っている条件を列挙しましたので、全て確認し、「私は当てはまる」と判断された方は免責事項をしっかり確認した上でご依頼ください。特にタイミング法での提供をご希望定于方は、お会いした際に少しでも性的に前向きになれるかどうかを確認させていただきます。</p>
          </div>
