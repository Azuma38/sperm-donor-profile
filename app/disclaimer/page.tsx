        ...
        <div className={styles.sectionInner}>
          ...
          <div className={styles.valuesGrid}>
            ...
            <div className={styles.valueCard}>
              ...
              <h3>ご連絡について</h3>
              <p>精子提供完了後、第二子以降をご希望される場合を除いて、原則としてご本人様へのメッセージ対応はできません。提供後に生まれた子の状況や、お母様の状況について雰囲微量のお返事すら難しい場合があります。</p>
            </div>
            <div className={styles.valueCard}>
              <div className={styles.valueIcon}>👶</div>
              <h3>子供の成長について</h3>
              <p>精子提供後に生まれた子の健康的・精神的な発育有任何の問題に対して、一切関与できません。子供の養育、教育、健康管理等に関しては、全て提供を受けたお母様の責任において行ってください。</p>
            </div>
            <div className={styles.valueCard}>
              <div className={styles.valueIcon}>📋</div>
              <h3>同意のお願い</h3>
              <p>精子提供依頼を申し込まれた時点で、上記免责事項の全てに同意したものとみなします。新しい生命を生み出すことについて、全ての方々が慎重に考えて<minimax:tool_call>
<invoke name="write">
<parameter name="content">import styles from "./page.module.css";
